...
const helpContent = {
    shellType: {
        header: 'çƒŸèŠ±ç±»åž‹',
        body: 'é€‰æ‹©å°†è¦å‘å°„çš„çƒŸèŠ±ç±»åž‹ã€‚ é€‰æ‹©â€œéšæœºâ€æ˜¯ä¸€ä¸ªä¸é”™çš„é€‰æ‹©ï¼'
    },
    shellSize: {
        header: 'çƒŸèŠ±å¤§å°',
        body: 'çƒŸèŠ±çš„å¤§å°ï¼šä»¥çœŸå®žçš„çƒŸèŠ±ç‚®å¼¹å°ºå¯¸ä¸ºæ¨¡åž‹ï¼Œè¾ƒå¤§çš„ç‚®å¼¹å…·æœ‰æ›´å¤§çš„çˆ†å‘åŠ›ï¼Œå¸¦æœ‰æ›´å¤šçš„æ˜Ÿæ˜Ÿï¼Œæœ‰æ—¶æ•ˆæžœæ›´å¤æ‚ã€‚ ä½†æ˜¯ï¼Œè¾ƒå¤§çš„å°ºå¯¸è¿˜éœ€è¦æ›´å¤šçš„å¤„ç†èƒ½åŠ›ï¼Œå¹¶ä¸”å¯èƒ½ä¼šå¯¼è‡´å»¶è¿Ÿã€‚'
    },
    quality: {
        header: 'ç”»è´¨',
        body: 'æ•´ä½“å›¾å½¢è´¨é‡ã€‚ å¦‚æžœåŠ¨ç”»è¿è¡Œä¸æµç•…ï¼Œè¯·å°è¯•é™ä½Žè´¨é‡ã€‚ é«˜è´¨é‡ä¼šå¤§å¤§å¢žåŠ äº§ç”Ÿçš„ç«èŠ±æ•°é‡ï¼Œå¹¶å¯èƒ½å¯¼è‡´æ»žåŽã€‚'
    },
    skyLighting: {
        header: 'å¤©ç©ºç…§æ˜Ž',
        body: 'çƒŸèŠ±çˆ†ç‚¸æ—¶ç…§äº®èƒŒæ™¯ã€‚ å¦‚æžœèƒŒæ™¯åœ¨å±å¹•ä¸Šçœ‹èµ·æ¥å¤ªäº®ï¼Œè¯·å°è¯•å°†å…¶è®¾ç½®ä¸ºâ€œæš—æ·¡â€æˆ–â€œæ— â€ã€‚'
    },
    scaleFactor: {
        header: 'è§„æ¨¡',
        body: 'å…è®¸ç¼©æ”¾æ‰€æœ‰çƒŸèŠ±çš„å¤§å°ï¼Œå®žè´¨ä¸Šä½¿æ‚¨é è¿‘æˆ–è¿œç¦»ã€‚ å¯¹äºŽè¾ƒå¤§çš„çƒŸèŠ±ç±»åž‹ï¼Œå¯ä»¥ç¨å¾®å‡å°æ¯”ä¾‹ï¼Œå°¤å…¶æ˜¯åœ¨æ‰‹æœºæˆ–å¹³æ¿ç”µè„‘ä¸Šã€‚'
    },
    autoLaunch: {
        header: 'è‡ªåŠ¨å‘å°„',
        body: 'å¯ç”¨æ­¤é€‰é¡¹å³å¯è‡ªåŠ¨å¯åŠ¨çƒŸèŠ±åºåˆ—ï¼Œå–æ¶ˆå‹¾é€‰ä½ å°±å¯ä»¥æ‰‹åŠ¨æŽ§åˆ¶çƒŸèŠ±çš„å‘å°„'
    },
    finaleMode: {
        header: 'ç»“å±€æ¨¡å¼',
        body: 'å‘å°„å¼ºçƒˆçš„çƒŸèŠ±ã€‚ å¯èƒ½ä¼šå¯¼è‡´å»¶è¿Ÿã€‚ éœ€è¦åŒæ—¶å¯ç”¨â€œè‡ªåŠ¨å‘å°„â€ã€‚'
    },
    hideControls: {
        header: 'éšè—æŽ§åˆ¶å™¨',
        body: 'éšè—å±å¹•é¡¶éƒ¨çš„åŠé€æ˜ŽæŽ§ä»¶ã€‚ å¯¹äºŽå±å¹•æˆªå›¾å¾ˆæœ‰ç”¨ï¼Œæˆ–è€…åªæ˜¯æ›´æ— ç¼çš„ä½“éªŒã€‚ éšè—åŽï¼Œæ‚¨ä»ç„¶å¯ä»¥ç‚¹å‡»å³ä¸Šè§’ä»¥é‡æ–°æ‰“å¼€æ­¤èœå•ã€‚'
    },
    fullscreen: {
        header: 'å…¨å±',
        body: 'åˆ‡æ¢å…¨å±æ¨¡å¼ã€‚'
    ...
    longExposure: {
        header: 'æ‰“å¼€å¿«é—¨',
        body: 'å®žéªŒæ•ˆæžœå¯ä»¥ä¿ç•™é•¿æ—¶é—´çš„å…‰çº¿ï¼Œç±»ä¼¼äºŽä¿æŒç›¸æœºå¿«é—¨æ‰“å¼€ã€‚'
    }
};
...
if (IS_HEADER) {
    ...
    //setLoadingStatus('çŒ®ç»™ä½ çˆ±çš„TA â¤');
    setTimeout(() => {
